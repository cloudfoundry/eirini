...
func (in *Healtcheck) DeepCopyInto(out *Healtcheck) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Healtcheck.
func (in *Healtcheck) DeepCopy() *Healtcheck {
	if in == nil {
		return nil
	}
	out := new(Healtcheck)
...
func (in *LRPSpec) DeepCopyInto(out *LRPSpec) {
	*out = *in
	...
	if in.AppRoutes != nil {
		in, out := &in.AppRoutes, &out.AppRoutes

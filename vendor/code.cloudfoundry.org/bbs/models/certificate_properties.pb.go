...
type CertificateProperties struct {
	OrganizationalUnit []string `protobuf:"bytes,1,rep,name=organizational_unit,json=organizationalUnit" json:"organizational_unit,omitempty"`
}
...
func (*CertificateProperties) Descriptor() ([]byte, []int) {
	return fileDescriptorCertificateProperties, []int{0}
}
...
func encodeFixed64CertificateProperties(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32CertificateProperties(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
...
func init() { proto.RegisterFile("certificate_properties.proto", fileDescriptorCertificateProperties) }

var fileDescriptorCertificateProperties = []byte{
	...
	0x18, 0x15, 0x98, 0x35, 0x38, 0x83, 0x84, 0x50, 0xa5, 0x42, 0xf3, 0x32, 0x4b, 0x9c, 0x74, 0x2e,
	...
	0x8c, 0x2f, 0x1e, 0xc9, 0x31, 0x7c, 0x78, 0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0x03, 0x20, 0x00,
	0x00, 0xff, 0xff, 0x93, 0x58, 0x60, 0x11, 0x9e, 0x00, 0x00, 0x00,
}

...
func (*ModificationTag) Descriptor() ([]byte, []int) {
	return fileDescriptor_modification_tag_8f4b50166beac13d, []int{0}
}
...
func (dst *ModificationTag) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ModificationTag.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("modification_tag.proto", fileDescriptor_modification_tag_8f4b50166beac13d)
}

var fileDescriptor_modification_tag_8f4b50166beac13d = []byte{
	...
	0x6a, 0x85, 0x04, 0x93, 0x02, 0xa3, 0x06, 0x2f, 0x4c, 0x0e, 0x2c, 0xe4, 0x64, 0x72, 0xe1, 0xa1,
	...
	0xb8, 0xf1, 0x58, 0x8e, 0x01, 0x10, 0x00, 0x00, 0xff, 0xff, 0x1d, 0x93, 0x02, 0x94, 0xd0, 0x00,
	0x00, 0x00,
}

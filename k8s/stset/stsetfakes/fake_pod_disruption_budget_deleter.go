...
func (fake *FakePodDisruptionBudgetDeleter) DeleteCallCount() int {
...
func (fake *FakePodDisruptionBudgetDeleter) DeleteReturnsOnCall(i int, result1 error) {
	fake.deleteMutex.Lock()
	defer fake.deleteMutex.Unlock()
	fake.DeleteStub = nil
...
func (fake *FakePodDisruptionBudgetDeleter) Invocations() map[string][][]interface{} {
...
func (fake *FakePodDisruptionBudgetDeleter) recordInvocation(key string, args []interface{}) {
...
var _ stset.PodDisruptionBudgetDeleter = new(FakePodDisruptionBudgetDeleter)

...
type FakeBifrost struct {
	...
	GetAppStub        func(ctx context.Context, identifier opi.LRPIdentifier) (*models.DesiredLRP, error)
...
func (fake *FakeBifrost) GetApp(ctx context.Context, identifier opi.LRPIdentifier) (*models.DesiredLRP, error) {
